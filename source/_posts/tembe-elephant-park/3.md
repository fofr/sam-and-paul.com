...
{% figure tembe-lion-sitting-in-road.jpg landscape %}
Lioness sitting in the road
{% endfigure %}

{% figure tembe-lions-brother-sister.jpg landscape %}
Brother and sister
{% endfigure %}

{% figure tembe-lion-in-grass.jpg landscape %}
Lioness in the grass
{% endfigure %}

{% figure tembe-landscape-with-giraffe.jpg portrait %}
Anxious giraffe
{% endfigure %}
...
{% figure tembe-reed-buck.jpg landscape %}
Reedbuck
{% endfigure %}

{% figure tembe-zebra.jpg landscape %}
Zebra
{% endfigure %}
...
{% figure tembe-dung-beetles.jpg landscape %}
Dung beetles doing what they’re famous for
{% endfigure %}
...
{% figure tembe-vervet-monkey-at-camp.jpg landscape %}
...
{% figure tembe-dog-in-boma.jpg landscape %}
Wild dog yearling in the boma
{% endfigure %}
...
{% figure tembe-drying-clothes.jpg portrait %}
Drying clothes back at camp
{% endfigure %}
...
{% figure tembe-elsa-outside-boma.jpg landscape %}
Elsa outside the boma
{% endfigure %}
...
{% figure tembe-towing-meat.jpg portrait %}
Dragging a leg of bait to spread the scent
{% endfigure %}

{% figure tembe-boma-tools.jpg landscape %}
Boma tools
{% endfigure %}

{% figure tembe-dogs-inside-elsa-outside.jpg landscape %}
Dogs inside the boma watching Elsa outside, near to the gate.
...
{% figure tembe-coffee-by-the-waterhole.jpg landscape %}
Coffee by the waterhole
{% endfigure %}
...
{% figure tembe-grey-duiker.jpg landscape %}
Grey duiker posing for a photo
{% endfigure %}
...
{% figure tembe-frisky-male-elephant.jpg landscape %}
A frisky male chasing another male
{% endfigure %}

{% figure tembe-sparring-bulls.jpg portrait %}
...
{% figure tembe-crowned-hornbill-by-hide.jpg landscape %}
Crowned hornbill
{% endfigure %}

{% figure tembe-sunbird-in-thorns.jpg landscape %}
Sunbird in the thorns
{% endfigure %}
...
{% figure tembe-wild-dog-feeding-on-scraps.jpg landscape %}
Wild dog feeding on scraps in the boma
{% endfigure %}

{% figure tembe-wild-dogs-evening-meal.jpg landscape %}
Wild dogs in boma finding an evening meal
{% endfigure %}
...
{% figure tembe-hanging-out-in-trees.jpg landscape %}
Peter and Hayden trying to find a signal from the tree tops
{% endfigure %}

{% figure tembe-sunset.jpg landscape %}
Sunset
{% endfigure %}
