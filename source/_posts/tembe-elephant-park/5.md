...
{% figure tembe-border-fence.jpg landscape %}
Searching along the fence line
{% endfigure %}

{% figure tembe-investigating-the-holes.jpg landscape %}
Hayden investigating the holes
{% endfigure %}

{% figure tembe-hayden-joris-with-log.jpg landscape %}
Plugging the holes
{% endfigure %}
...
{% figure tembe-leopard-track.jpg landscape %}
My hand besides a leopard track
{% endfigure %}
...
{% figure tembe-black-collared-barbet.jpg landscape %}
Black-collared barbet
{% endfigure %}

{% figure tembe-lilac-roller.jpg landscape %}
A lilac roller flying by
{% endfigure %}

### Elephants in the mud

{% figure tembe-caution-dung-beetles.jpg landscape %}
Heading out on session with Leo, past the dung beetle sign at the entrance
{% endfigure %}
...
{% figure tembe-lapwing-missing-foot.jpg landscape %}
White-crowned lapwing, missing a foot
{% endfigure %}

{% figure tembe-elephant-enjoying-mud.jpg landscape %}
Elephant enjoying the mud
{% endfigure %}
...
{% figure tembe-thread-snake.jpg portrait %}
Hayden showing Lindsey a thread snake
{% endfigure %}
...
{% figure tembe-scanning-for-dogs.jpg landscape %}
Me scanning for dogs
{% endfigure %}

{% figure tembe-climbing-trees-to-find-dogs.jpg landscape %}
Climbing trees to find the dogs, me on lookout
{% endfigure %}
...
{% figure tembe-african-wild-dog.jpg landscape %}
A yearling, one of the wild dogs still in the boma
{% endfigure %}

{% figure tembe-yearling-snare-wound.jpg landscape %}
Another yearling, with an old snare wound
{% endfigure %}

{% figure tembe-wild-dogs-feeding.jpg landscape %}
Dogs feeding on a nyala carcass
{% endfigure %}

{% figure tembe-dog-with-organ.jpg landscape %}
Dog running off with a tasty organ
{% endfigure %}
...
{% figure tembe-rock-monitor.jpg landscape %}
Rock monitor lizard
{% endfigure %}

{% figure tembe-elephant-skull.jpg landscape %}
Me besides an elephant skull while the truck is getting cleaned
{% endfigure %}
...
{% figure tembe-martial-eagle.jpg landscape %}
Martial eagle
{% endfigure %}

{% figure tembe-baby-giraffe.jpg landscape %}
A young giraffe
{% endfigure %}
...
{% figure tembe-elephant-in-must.jpg landscape %}
Elephant in must
{% endfigure %}

{% figure tembe-elephant-coming-our-way.jpg landscape %}
Elephant coming our way
{% endfigure %}
...
{% figure tembe-where-are-the-dogs.jpg landscape %}
Where are the dogs?
{% endfigure %}
...
{% figure tembe-waiting-for-the-rain-to-stop.jpg landscape %}
...
{% figure tembe-setting-up-camera-trap.jpg landscape %}
Setting up a camera trap, nyala bait on the left
{% endfigure %}

{% figure tembe-drizzle-and-sand.jpg landscape %}
Lynn on the truck, enjoying the rain
{% endfigure %}
...
{% figure tembe-gorgeous-bush-shrike.jpg landscape %}
A gorgeous bush-shrike!
{% endfigure %}
...
{% figure tembe-worm-snake.jpg landscape %}
The worm snake
{% endfigure %}
...
{% figure tembe-callup-with-speakers.jpg landscape %}
The call-up set-up
{% endfigure %}
...
{% figure tembe-hayden-making-potjie.jpg landscape %}
Hayden making potjie
{% endfigure %}

{% figure tembe-potjie.jpg landscape %}
Potjie!
{% endfigure %}
